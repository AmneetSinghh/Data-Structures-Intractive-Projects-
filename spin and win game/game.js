...
function spinwheel() {
    ...
    let rounds = Phaser.Math.Between(2, 4);// random rounds 2 -4
    let degrees = Phaser.Math.Between(0, 11) * 30;// random degrees 0 - 11 multiple by 30;

    let total_angle = rounds * 360 + degrees;
    console.log(total_angle);

    // this is the main logic baby
    let idx = prizes_config.count - 1 - Math.floor(degrees / (360 / prizes_config.count));

// this is the small animation 
